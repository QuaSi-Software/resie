...
Calculates energy flow in an interface and returns the energy.
If the balance in an interface was not zero, the acutal energy that has been provided is 
returned, not the requested amount of energy!
"""
