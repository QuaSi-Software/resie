...
"""
function calc_thermal_power_fixed_delta_T!(unit::SolarthermalCollector, sim_params::Dict{String,Any})
...
"""
function calc_thermal_power_fixed_flow_rate!(unit::SolarthermalCollector, sim_params::Dict{String,Any})
