...
mutable struct GeothermalHeatCollector <: Component
    ...
    function GeothermalHeatCollector(uac::String, config::Dict{String,Any}, sim_params::Dict{String,Any})
        ...
        return new(
            ...
            default(uac, config, "loading_temperature", nothing),        # nominal high temperature for loading geothermal heat collector storage, can also be set from other end of interface
