...
in the system framework. While the connection matrix of each bus only defines the loading of directly
...
NOTE: This is only implemented in a downstream way with regards to the ouput energies. Controlling if a 
      ...
      simulation model (balances in interfaces are writte from upstream energy systems without the information
      of the source of this energy to decouple energy systems from each other) and therefore not implemented. 
"""
