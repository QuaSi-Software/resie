...
# ------------------------------------------------------------
input_path  = raw"C:\Users\demartin\Software\resie_optim\profiles\hafner\SWK\price_inkl_all.csv"
output_path = raw"C:\Users\demartin\Software\resie_optim\profiles\hafner\SWK\price_volatility_inkl_all.csv"

df_raw = CSV.read(input_path, DataFrame; normalizenames=true, delim=';')
