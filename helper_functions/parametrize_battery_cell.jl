...
scaled by 0.1 example Paper SP-LFP1000AHA:
calc_cell_values(10, 3.4, 3.346, 1, 3.332, 2, 3.216, 82, 2.0, 108.75,
                 100, 106.15,
                 nothing, 3.141, 55,
                 50, 1000, 102.6,
                 3000, 3.2, 3.15, 40, 80.6,
                 50, -20, 98.7,         
                 55, 3.31, 3.277, 69.6, 103.5,
                 25)

VRFB
calc_cell_values(25, 1.575, 1.481174, 7.0, 1.435652, 14.0, 1.252377, 105, 1.0, 134.792,
                 50, 126.42,
                 nothing, 1.24905, 70.0,
                 0.0, 0.0, 0.0,
                 nothing, 0.0, 0.0, 0.0, 0.0,
                 25, 26, 134.792,         
                 38, 1.575, 1.295576, 70.0, 131.67,
                 25)

VRFB with reduced max voltage for discharge
calc_cell_values(25, 1.495, 1.45294, 7.0, 1.4275, 14.0, 1.252377, 105, 1.0, 134.792,
                 50, 126.42,
                 nothing, 1.24905, 70.0,
                 0.0, 0.0, 0.0,
                 nothing, 0.0, 0.0, 0.0, 0.0,
                 25, 26, 134.792,         
                 38, 1.465, 1.29558, 70.0, 131.67,
                 25)

VRFB with fitted parameters
calc_cell_values(25, 1.505, 1.4174, 18.2, 1.3844, 36.4, 1.2111, 116.2, 1.0, 134.792,
                 50, 126.42,
                 nothing, 1.24905, 70.0,
                 0.0, 0.0, 0.0,
                 nothing, 0.0, 0.0, 0.0, 0.0,
...
calc_cell_values(25, 1.505, 1.40697, 24.5, 1.359556, 49, 1.268, 103.6, 1.0, 134.792,
                 50, 126.42,
                 nothing, 1.24905, 70.0,
                 0.0, 0.0, 0.0,
                 nothing, 0.0, 0.0, 0.0, 0.0,
